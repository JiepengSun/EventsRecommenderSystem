 ...
 *		category is needed because we want to do recommendation based on it.
 *		Latitude and Longitude are needed because we need to use it to sort recommendation result based on distance.
 *		itemID is needed because that’s the primary identifier for an event, which is useful when we save event into our database.
 *	Based on frontend UI design: 
 *		Frontend UI should clearly show some information for our clients. Rating, address, description, etc.
 *
 */
