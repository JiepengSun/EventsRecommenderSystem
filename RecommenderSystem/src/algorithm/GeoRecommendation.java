...
// Sort by geo information
// Based on geo distance and similar categories
public class GeoRecommendation {
	...
	public List<Item> recommendItems(String userId, double lat, double lon) {
		...
		// step 1  // db queries get fav ids
	    Set<String> favoriteItems = conn.getFavoriteItemIds(userId);  

	    //step 2 search each item's category, use set to avoid duplicate
