...
public class TicketMasterAPI implements ExternalAPI  {
	...
	private static final String API_KEY = "KuL0lQF36iUP7ejar4Qldikw3R0CZO6J";
	...
	public List<Item> search(double lat, double lon, String term) {
		...
		try {
			...
			// getResponseCode will send request first, then get response code
			int responseCode = connection.getResponseCode();
			System.out.println("\nSending 'GET' request to URL : " + url + "?" + query);
			System.out.println("Response Code : " + responseCode);
			
			// Now read response body to get events data
			// from client side, the imput is the response from the server
	...
	// Call search function, get JSON array, print JSON array
	 ...
	 * Helper methods
	 */
	// Convert JSONArray to a list of item objects (Item Instance).
	// Data field from JSON object -> Item Builder -> Item
